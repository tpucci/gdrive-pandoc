...
\begin{center}
\Huge \textbf{Offre ECL PRO de Jeu Lean Engineering}\\
\vspace{1cm}
\LARGE Projet intégratif Ingénieur Business Development\\
\Large S9 IBDE MSM 3.4\\
\end{center}
 
\vspace{3cm}
 
\noindent
Vincent \textsc{Arthaud} \\
Mickaël \textsc{Leclerc} \\
Loup \textsc{Ortiz} \\
Thomas \textsc{Pucci} \\
Yann \textsc{Vaginay} \\
\vspace{0.5cm}
\noindent
\textbf{Septembre - Novembre 2016}\\
